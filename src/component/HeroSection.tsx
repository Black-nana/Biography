...
const HeroSection = () => {
  return (
    <div className="py-20 grid lg:grid-cols-4 place-items-center lg:h-[70vh] w-full bg-blue-900 ">
      <div className="flex-col lg:flex col-span-3 w-full pl-16 ">
        ...
        <FadeIn>
          <div className="capitalize ">
            <p className="text-6xl font-sans font-medium text-[#f5f7fa]">
              I am a web developer
            </p>
            <p className="text-3xl font-bold text-[#dde9fb]">
              Abdul Mateen Kofi Yeboah
            </p>
            <p className="py-8 text-[#dde9fb]">
            ...
            <div className="flex gap-4">
              ...
              <button className="py-3 px-6 rounded bg-[#82b2f0] text-slate-800">
                Contact Me
              </button>
            </div>
          </div>
      ...
      <div className="pr-16 hidden lg:block ">
        <SlidingCard />
      </div>
    </div>
  );
