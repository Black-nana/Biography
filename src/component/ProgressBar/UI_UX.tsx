...
const UI_UX: React.FC<MarketingProps> = () => {
 ...
 return (
  ...
  ></div>
  <div className="absolute top-0 left-0 w-full p-3 pb-2 h-full flex items-center justify-start text-white font-light text-sm">
    UI/UX
  </div>
</div>
